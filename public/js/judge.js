...
const Judge = {
    ...
    renderDashboard: function() {
        ...
        // Header info
        document.getElementById('judge-name-display').textContent = `กรรมการ: ${d.judge_name}`;
        document.getElementById('judge-round-code').textContent = d.active_round.code.replace('_', ' ');
        document.getElementById('judge-round-title').textContent = `${d.active_round.name} — ${d.active_round.subtitle}`;

        // Header Stats
        document.getElementById('stat-total-contestants').textContent = `${d.total_contestants} คน`;
        document.getElementById('stat-voted').textContent = `${d.voted_count} คน`;
        document.getElementById('stat-remaining').textContent = `${d.remaining_count} คน`;
